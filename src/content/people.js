...
export const peopleEn = {
  ...
  },
  {
    ...
    name: `Jan Roleček`,
    position: `Researcher`,
    description: `I am interested in ecology and diversity of vegetation, especially forest-steppe habitats such as thermophilous oak forests and steppe meadows. Besides describing this diversity, I also try to understand its causes, which has led me to study forest steppes in remote areas of Eurasia, and also to explore their history on different time scales. As a graduate in the field of Environmental Conservation (Palacký University in Olomouc), I am also concerned with the protection of endangered species and habitats and I devote part of my work to them. After completing my PhD in Botany at Masaryk University (2001–2007), I stayed faithful to the Institute of Botany and Zoology and at the same time I work at the Institute of Botany of the Czech Academy of Sciences. I have lectures in Forest ecology, Protected areas of the Czech Republic, Quaternary environments (with M. Horsák) and Special field practice in botany and zoology (with the whole Biotým).`,
...
`,
  ...
  },
  {
    ...
    name: `Dana Holubová`,
    position: `Researcher`,
    description: `Dana Holubová studied Systematic botany and ecology at Masaryk University, Faculty of Science, Department of Botany and Zoology, in Brno, Czech Republic. She continued with postgraduate studies at the same department and in 2016 defended Ph.D. thesis focused on diversity of vegetation on a landscape scale. She created a web application Botanical photogallery in 2011, which she still manages. Currently she is a research assistant at the Department of Botany and Zoology, Masaryk university, where is devoted to plant photography and collecting  photos for a web application PLADIAS.`,
  ...
  },
  {
    ...
    name: `Ilona Knollová`,
    position: `Researcher`,
    description: `Ilona Knollová studied Systematic botany and ecology at Masaryk University, Faculty of Science, Department of Botany and Zoology, in Brno, Czech Republic. She continued with postgraduate studies at the same department and in 2006 defended Ph.D. thesis focused on Local and large-scale data sets and their use for vegetation classification. Currently she works as manager of Czech National Phytosociological Database and EVA (European Vegetation Archive).`,
  ...
  phdStudents: [
  {
    ...
    position: `Researcher`,
    description: `Since I graduated in landscape design at the Mendel university, I have been making my way through the studies of Botany at the Masaryk university. Still passionate for growing plants, I’m taking care of our expanding home collection of succulents. With my colleagues from the Institute of Botany, I also ventured into experimental planting of woodland herbs. My main research domain is forests and woodlands, where I spend time all-year-round, mostly collecting data. I’m writing my dissertation on the origin of spatial patterns in plant communities and, as a part of my work at the Institute of Botany, I’m studying their temporal dynamics. I’m drawn to detail; small scale and short time-periods. Once, I would like to find there the answer for long-term community changes.`,
