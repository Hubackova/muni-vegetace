...
export const peopleEn = {
  employees: [
    ...
    },
    {
      ...
      position: `Researcher`,
      description: `Zdenka Preislerová studied Botany and Geobotany at Masaryk University, and her Master Thesis was focused on the weed vegetation in the White Carpathians (1999). Results were published as a monograph in 2001. She dealt with the influence of various plot size on analysis and classification of vegetation on the example of forest and grassland vegetation (2006) in PhD study. She is interested in the reason of differences in various species richness of dry and semi-dry grasslands in the White Carpathians and other regions. Currently, she is involved in processing of distribution of European alliances.`,
    ...
    },
    {
      ...
      position: `Researcher`,
      description: `Eva Šmerdová studied Plant Systematics and Ecology at University of Ostrava. She continued in master study of botany at Masaryk University, Brno and was graduated in 2006. Her master thesis dealt with the effect of contact plant communities on the species composition of spring fens. Her PhD thesis dealt with species richness of plants and molluscs along the moisture gradient. Currently, she works on public relation of botany and zoology, mainly to the students of high and secondary school. She cooperates on the projects dealing with 1) the influence of the artificial snow to vegetation, 2) the refugia of endangered fen plant species. She also works on the database of plant macrofossils of Czech and Slovak Republic. She likes to travel with co-workers to sample field data for the next research.`,
    ...
    },
    {
      ...
      description: `Markéta Táborská studied Systematic Biology and Ecology with specialization on Botany. She finished her studies in 2018 by defending her Ph.D. thesis focused on diversity and ecology of epixylic bryophytes. She worked on this topic not only as a part of her Ph.D. research but also participated on several projects dealing with diversity and dynamics of natural forests in Czech Republic. In the present time she is colaborating on a project describing european scaled biodiversity pattern of dead wood inhabiting bryophytes in old-growth beech forests.`,
...
export const peopleCz = {
  employees: [
    ...
    },
    {
      ...
      name: `Zdenka Preislerová`,
      position: `Výzkumník`,
      description: `Zdenka Preislerová studovala na Masarykově univerzitě obor systematická botanika a geobotanika. Ve své diplomové práci se věnovala studiu plevelové vegetace v Bílých Karpatech. V navazujícím doktorském studiu studovala na příkladu lesní i luční vegetace vliv velikosti plochy na analýzy a klasifikaci vegetace. Zajímavá krajina moravských Karpat a nezodpovězené otázky týkající se rozdílné druhové diverzity suchých stávníků na jižní Moravě ve srovnání s bělokarpatskými loukami se odrazily v předmětu jejího dalšího studia. V současné době se také podílí na zpracování rozšíření svazů evropské vegetace.`,
      email: `zpreislerova@gmail.com`,
      phoneNumber: `549498477`,
    ...
    },
    {
      ...
      name: `Markéta Táborská`,
      position: `Výzkumník (mateřská dovolená)`,
      description: `Markéta Táborská studovala systematickou biologii a ekologii se zaměřením botanika. Studium ukončila r. 2018 obhájením dizertační práce věnující se diverzitě a ekologii epixylických mechorostů. Tomuto tématu se věnovala nejen v rámci studia, ale také při realizaci několika projektů zaměřených především na průzkum diverzity a dynamiky přirozených lesů u nás. V současné době se se podílí na projektu mapujícím biodiverzitu mechorostů na tlejícím dřevě v přirozených bukových porostech Evropy.`,
      email: `taborska.mar@gmail.com`,
      phoneNumber: `549498474`,
